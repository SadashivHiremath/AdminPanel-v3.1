...
class Helpers
{
    ...
    public static function send_order_notification($order)
    {
        ...
        try {
            ...
            if($order->order_type == 'delivery' && !$order->scheduled && $order->order_status == 'pending' && $order->payment_method == 'cash_on_delivery')
            {
                $data = [
                    'title' =>trans('messages.order_push_title'),
            ...
            if($order->order_type == 'take_away' && !$order->scheduled && $order->order_status == 'pending')
            {
                $data = [
                    'title' =>trans('messages.order_push_title'),
                    'description' => trans('messages.new_order_push_description'),
            ...
            if(!$order->scheduled && $order->order_status == 'confirmed' )
            {
                $data = [
                    'title' =>trans('messages.order_push_title'),
                    'description' => trans('messages.new_order_push_description'),
            ...
            if($order->order_type == 'delivery' && !$order->scheduled && $order->order_status == 'confirmed'  && $order->payment_method != 'cash_on_delivery')
            {
                $data = [
                    'title' =>trans('messages.order_push_title'),
                    'description' => trans('messages.new_order_push_description'),
