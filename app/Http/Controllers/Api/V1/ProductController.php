...
class ProductController extends Controller
{
    ...
    public function get_product($id)
    {
        ...
        try {
            ...
            return response()->json([
                'errors' => ['code' => 'product-001', 'message' => 'Food not found!', 'error'=>$e]
            ], 404);
        }
    }
    ...
    public function get_related_products($id)
    {
        ...
        return response()->json([
            'errors' => ['code' => 'product-001', 'message' => 'Food not found!']
        ], 404);
    }
    ...
    {
        $reviews = Review::with(['customer'])->where(['food_id' => $food_id])->get();
